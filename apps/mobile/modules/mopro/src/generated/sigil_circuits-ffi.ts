...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_sigil_circuits_fn_func_compute_redc_param(modulusBytes: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_sigil_circuits_fn_func_compute_sigil_inputs(dg1Hash: Uint8Array, sodHash: Uint8Array, epochDay: Uint8Array, signedAttrs: Uint8Array, signedAttrsLen: number, signature: Uint8Array, pubkey: Uint8Array, redcParam: Uint8Array, exponent: number, dscTbs: Uint8Array, dscTbsLen: number, dscPubkeyOffset: number, cscaPubkey: Uint8Array, cscaRedcParam: Uint8Array, cscaExponent: number, cscaSignature: Uint8Array, cscaMerkleSiblings: Uint8Array, cscaLeafIndex: number, hashedAddress: Uint8Array, cscaMerkleRoot: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_sigil_circuits_fn_func_generate_noir_proof(circuitPath: Uint8Array, srsPath: Uint8Array, inputs: Uint8Array, onChain: number, vk: Uint8Array, lowMemoryMode: number, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_sigil_circuits_fn_func_get_noir_verification_key(circuitPath: Uint8Array, srsPath: Uint8Array, onChain: number, lowMemoryMode: number, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_sigil_circuits_fn_func_verify_noir_proof(circuitPath: Uint8Array, proof: Uint8Array, onChain: number, vk: Uint8Array, lowMemoryMode: number, uniffi_out_err: UniffiRustCallStatus): number;
    ubrn_uniffi_sigil_circuits_checksum_func_compute_redc_param(): number;
    ubrn_uniffi_sigil_circuits_checksum_func_compute_sigil_inputs(): number;
    ubrn_uniffi_sigil_circuits_checksum_func_generate_noir_proof(): number;
    ubrn_uniffi_sigil_circuits_checksum_func_get_noir_verification_key(): number;
    ubrn_uniffi_sigil_circuits_checksum_func_verify_noir_proof(): number;
    ubrn_ffi_sigil_circuits_uniffi_contract_version(): number;
}

// Casting globalThis to any allows us to look for `NativeSigilCircuits`
// if it was added via JSI.
//
// We use a getter here rather than simply `globalThis.NativeSigilCircuits` so that
// if/when the startup sequence isn't just so, an empty value isn't inadvertantly cached.
const getter: () => NativeModuleInterface = () => (globalThis as any).NativeSigilCircuits;
