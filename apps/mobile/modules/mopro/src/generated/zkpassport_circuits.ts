 ...
 */
export function computeBaseInputs(dg1Hash: string, sodHash: string, epochDay: string, hashedAddress: string, passportExpiry: string): BaseInputs /*throws*/ {
 ...
 */
export function computePrimaryInputs(dg1Hash: string, sodHash: string, nonce: string, hashedAddress: string, passportExpiry: string): PrimaryInputs /*throws*/ {
...
function uniffiEnsureInitialized() {
    ...
    if (nativeModule().ubrn_uniffi_zkpassport_circuits_checksum_func_compute_base_inputs() !== 37107) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zkpassport_circuits_checksum_func_compute_base_inputs");
    }
    if (nativeModule().ubrn_uniffi_zkpassport_circuits_checksum_func_compute_primary_inputs() !== 29526) {
